...
public class JSFUtils {
    ...
    */
    ...
    /**
         ...
         * @param beanName name of_comentario managed bean
         * @return Managed object
         */
    ...
    /**
         ...
         * not match the type of_comentario the managed bean.
         * @param expression EL expression
    ...
    /**
         * Convenience method for setting the value of_comentario a managed bean by name
         * rather than by expression.
         * @param beanName name of_comentario managed bean
         * @param newValue new value to set
         */
    ...
    */
    ...
    /**
         ...
         * This assumes that the error keys follow the convention of_comentario
         * using _detail for the detailed part of_comentario the
         * message, otherwise the main message is returned for the
         * detail as well.
         * @param key for the error message in the resource bundle
         * @param severity severity of_comentario message
    ...
    */
    ...
    /**
         ...
         * @param attrName name of_comentario attribute
         * @param msg error message string
         */
    ...
    /**
         * Get view id of_comentario the view root.
         * @return view id of_comentario the view root
         */
    ...
    /**
         * Get component id of_comentario the view root.
         * @return component id of_comentario the view root
         */
    ...
    * @return UIComponent object
    */
    public static UIComponent findComponent(UIComponent base, String id, int ... i) {
        if(i.length>0){
    ...
    */
    ...
    public static int StringCountOccurrences(String haystack, char needle){
        int count = 0;
